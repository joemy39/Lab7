...
/**
 * RPSLSpock class for evaluating player's choice, creating computer's choice, and determining the winner
...
public class RPSLSpock {
    ...
    /**
     * Check for valid RPSLSpock pick by player
     * @param pick the choice of the player from input
     * @return trimmed pick or false if null
     */
    ...
    /**
     * Generate computer's pick using random numbers
    ...
    /**
     * Compares the picks of player and computer to determine winner
     * @param c_pick computer's pick
     * @param h_pick player's pick
     * @return true if computer wins and false if computer loses
     */
